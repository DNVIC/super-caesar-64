...
const BehaviorScript bhvSenate[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_HOME(),
    CALL_NATIVE(bhv_senate_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_senate_loop),
    END_LOOP(),
};

const BehaviorScript bhvGaul[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_HOME(),
    CALL_NATIVE(bhv_gaul_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_gaul_loop),
    END_LOOP(),
};

const BehaviorScript bhvStarSpawner[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_HOME(),
    CALL_NATIVE(bhv_star_spawner_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_star_spawner_loop),
    END_LOOP(),
};
