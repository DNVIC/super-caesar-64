...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		WARP_NODE(0xF0, LEVEL_JRB, 0x01, 0x01, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 2801, -416, 0, 0, 0, 0, 0x00000000, bhvSenate),
		OBJECT(MODEL_KOOPA_WITH_SHELL, -778, 19, -4, 0, 0, 0, 0x00000000, bhvKoopa),
		OBJECT(MODEL_NONE, -778, 19, -4, 0, 0, 0, 0x00000000, bhvStarSpawner),
		TERRAIN(wf_area_1_collision),
		MACRO_OBJECTS(wf_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_CONFIGURATION),
